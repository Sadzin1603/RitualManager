        ...
        <div className="header">
          <div className="header-layout relative">
            ...
            <div className="absolute right-0">
              ...
              : ""}
              {/*   Botão de copiar   */}
              <button className="absolute top-[-1rem] right-[-1.5rem] bg-[#18181B] rounded-lg" onClick={()=>setOpen(true)}>
              ...
              {/*   Botão de deletar   */}
              {ritual?.creator.id == (jwtDecode(token) as any).id ?
              <button className="absolute top-[-1rem] right-[5rem] bg-[#18181B] rounded-lg" onClick={()=>setOpenModalDelete(true)}>
