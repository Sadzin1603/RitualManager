        ...
        <div className="header">
          <div className="header-layout relative">
            ...
            <div className="div-botoes absolute right-3 top-3">
              {/*   Botão de editar   */}
              {ritual?.creator.id == (jwtDecode(token) as any).id ?
                <button className="absolute top-[-1.5rem] right-[1.5rem] bg-[#0c0c0c] rounded-lg p-2" onClick={() => navigate("/rituais", { state: ritual })} >
                ...
                : ""}
              {/*   Botão de copiar   */}
              <button className="absolute top-[-1.5rem] right-[-1.5rem] bg-[#0c0c0c] rounded-lg p-2" onClick={() => setOpen(true)}>
              ...
              {/*   Botão de deletar   */}
              {ritual?.creator.id == (jwtDecode(token) as any).id ?
                <button className="absolute top-[-1.5rem] right-[4.5rem] bg-[#0c0c0c] rounded-lg p-2" onClick={() => setOpenModalDelete(true)}>
